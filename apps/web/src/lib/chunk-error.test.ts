...
// Bug 2026-09-07 — màn quản lý trắng tinh sau mỗi lần deploy. Chuỗi nguyên nhân đầy đủ nằm
...
describe('isChunkLoadError', () => {
  ...
  it.each([
    ['Chrome/Edge', 'Failed to fetch dynamically imported module: https://admin.quanbalun.site/assets/AdminUsersPage-B7xK2p.js'],
    ['Firefox', 'error loading dynamically imported module'],
    ['Safari', 'Importing a module script failed.'],
    ['Vite (CSS đi kèm)', 'Unable to preload CSS for /assets/AdminUsersPage-B7xK2p.css'],
