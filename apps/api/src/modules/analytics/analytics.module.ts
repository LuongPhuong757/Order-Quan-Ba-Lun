...
//   - ĐỌC (`AdminAnalyticsController`): ReportGuard (admin + report), gộp bằng SQL, gọi theo
//     nhịp người bấm.
//
...
@Module({
  // AuthModule cung cấp JwtAuthGuard mà ReportGuard phụ thuộc (khuôn AdminModule).
  imports: [AuthModule],
