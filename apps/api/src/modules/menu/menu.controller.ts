...
class UpdateMenuItemDto {
  ...
  // `is_menu_hidden` và `menu_sort_order` KHÔNG còn nhận qua PATCH từ 2026-09-15 (M4.D-36):
  // quyển menu hiện đúng danh sách POS, không có cấu hình riêng. Xem docblock ở entity.
}
