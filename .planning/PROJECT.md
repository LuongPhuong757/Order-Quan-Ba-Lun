...
| Ảnh design ref mobile + logo/màu **chốt trước** Phase 8 | M2.D-71: thiếu ảnh mobile là rủi ro lớn nhất, khách gần 100% dùng điện thoại | ✓ Ảnh mobile (cart + menu) đã có 2026-07-29 → `docs/design-refs/lotteria/README.md`. Còn thiếu logo/màu quán + ảnh item detail/checkout b2 |
